...
public class ServiceCollectionExtensionsTests
{
    ...
    public class TestHandler : IHandler<TestRequest, Result<string>>
    {
    ...
    public class AnotherRequest : IRequest<Result<int>>
    {
        public int Number { get; set; }
    }

    public class AnotherHandler : IHandler<AnotherRequest, Result<int>>
    {
